...
public abstract class ProdutoComumDetalheCallbackHtmlBase  extends CallbackParseHtml{

	protected ProdutoComumDadosParseBase dadosParse;
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		dadosParse = (ProdutoComumDadosParseBase) paramIDadosParse;
		ArquivoLog.getInstancia().salvaLog("ProdutoComum(detalhe):"  + dadosParse.displayLog(dadosParse.getItemDetalhe()));
	}
	...
	public final void finalizacaoOk() {
		//if (lista==null) throw new RuntimeException("objeto lista em ProdutoComumListaCallbackHtmlBase esta null");
		finalizaObjeto();
	...
	private void limpaListasInternas() {
		...
		this.dadosParse.getItemDetalhe().setListaPrecoLoja_Possui(null);
 	
		this.dadosParse.getItemDetalhe().setListaCategoriaProduto_Associada(null);
