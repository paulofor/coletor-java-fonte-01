...
public abstract class ProdutoComumListaCallbackHtmlBase  extends CallbackParseHtml{
	...
	protected ProdutoComum corrente = null;
	...
	public final void finalizacaoErro() {
		...
		//if (lista==null) throw new RuntimeException("objeto lista em ProdutoComumDetalheCallbackHtmlBase esta null");
