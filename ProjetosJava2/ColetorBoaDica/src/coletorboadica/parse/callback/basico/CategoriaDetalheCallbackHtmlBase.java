...
public abstract class CategoriaDetalheCallbackHtmlBase  extends CallbackParseHtml{
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		...
		ArquivoLog.getInstancia().salvaLog("Categoria(detalhe):"  + dadosParse.displayLog(dadosParse.getItemDetalhe()));
	}
