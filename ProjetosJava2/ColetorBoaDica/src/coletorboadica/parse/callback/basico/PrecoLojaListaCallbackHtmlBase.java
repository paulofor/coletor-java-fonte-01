...
public abstract class PrecoLojaListaCallbackHtmlBase  extends CallbackParseHtml{

	protected PrecoLojaDadosParseBase dadosParse;
	protected boolean ligaColetaLista = false;
	protected List<PrecoLoja> lista = null;
	protected PrecoLoja corrente = null;
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		dadosParse = (PrecoLojaDadosParseBase) paramIDadosParse;
	}
	...
	public final void finalizacaoErro() {
		...
		//if (lista==null) throw new RuntimeException("objeto lista em PrecoLojaDetalheCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}

	@Override
	public final void finalizacaoOk() {
		//if (lista==null) throw new RuntimeException("objeto lista em PrecoLojaListaCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}
