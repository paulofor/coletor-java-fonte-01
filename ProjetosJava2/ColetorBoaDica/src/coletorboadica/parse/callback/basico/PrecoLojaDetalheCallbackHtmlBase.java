...
public abstract class PrecoLojaDetalheCallbackHtmlBase  extends CallbackParseHtml{
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		...
		ArquivoLog.getInstancia().salvaLog("PrecoLoja(detalhe):"  + dadosParse.displayLog(dadosParse.getItemDetalhe()));
	}
