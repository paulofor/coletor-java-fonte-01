package coletorboadica.dao.montador;
...
public class PrecoLojaMontador   implements MontadorDaoI { 
    ...
    public  DCIObjetoDominio extraiRegistro( ResultadoLista resultadoLista )  throws  DaoException{
		...
		objeto = FabricaVo.criaPrecoLoja();
	...
	public  DCIObjetoDominio extraiRegistro( ResultadoLista resultadoLista  ,  DCIObjetoDominio entrada  ,  int pos )  throws  DaoException{
		PrecoLoja objeto;
		objeto = (PrecoLoja)entrada;
		  
	  	objeto.setIdPrecoLoja(resultadoLista.getInt(pos++));  
	  	objeto.setData(resultadoLista.getString(pos++));  
	  	objeto.setNomeLoja(resultadoLista.getString(pos++));  
	  	objeto.setCodigoLoja(resultadoLista.getString(pos++));  
	  	objeto.setValor(resultadoLista.getFloat(pos++));  
	  	objeto.setBairroLoja(resultadoLista.getString(pos++));  
	  	objeto.setMunicipioLoja(resultadoLista.getString(pos++));  
	  	objeto.setIdProdutoComumRa(resultadoLista.getInt(pos++));
      	return objeto;
	}
