...
public class CategoriaProdutoMontador   implements MontadorDaoI { 
    ...
    public  DCIObjetoDominio extraiRegistro( ResultadoLista resultadoLista )  throws  DaoException{
		...
		objeto = FabricaVo.criaCategoriaProduto();
	...
	public  DCIObjetoDominio extraiRegistro( ResultadoLista resultadoLista  ,  DCIObjetoDominio entrada  ,  int pos )  throws  DaoException{
		...
		objeto = (CategoriaProduto)entrada;
		  
	  	objeto.setIdCategoriaProduto(resultadoLista.getInt(pos++));  
	  	objeto.setIdProdutoComumA(resultadoLista.getInt(pos++));  
	  	objeto.setIdCategoriaA(resultadoLista.getInt(pos++));
      	return objeto;
	}
