...
import dafitiafil.regracolecao.filtro.MarcaFiltro;
...
public abstract class MarcaDaoBase extends DaoAplicacao implements MarcaDaoBaseI {
	...
	public void excluiItem(Marca item) throws DaoException {
		String query = null;
		query = " delete from filme  where id_marca = " + item.getIdMarca();
		executaSql(query);
	}
	@Override
	...
	/*
	public Marca obtemPorProdutoPossui(long id) {
		string sql;
		sql = "select " + camposOrdenados() +
			" from " + tabelaSelect() +
	...
	*/
	public static String innerJoinProduto_Possui() {
		return " inner join " + ProdutoDaoBase.tabelaSelect() + " on " + ProdutoDaoBase.tabelaSelect() + ".id_marca_pa = " + tabelaSelect() + ".id_marca ";  
	}
	public static String outerJoinProduto_Possui() {
		return " left outer join " + ProdutoDaoBase.tabelaSelect() + " on " + ProdutoDaoBase.tabelaSelect() + ".id_marca_pa = " + tabelaSelect() + ".id_marca ";  
	}
