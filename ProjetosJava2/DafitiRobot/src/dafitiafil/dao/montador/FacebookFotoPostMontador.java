...
public class FacebookFotoPostMontador   implements MontadorDaoI { 
    ...
    public  DCIObjetoDominio extraiRegistro( ResultadoLista resultadoLista )  throws  DaoException{
		...
		objeto = FabricaVo.criaFacebookFotoPost();
	...
	public  DCIObjetoDominio extraiRegistro( ResultadoLista resultadoLista  ,  DCIObjetoDominio entrada  ,  int pos )  throws  DaoException{
		FacebookFotoPost objeto;
		objeto = (FacebookFotoPost)entrada;
		  
	  	objeto.setIdFacebookFotoPost(resultadoLista.getInt(pos++));  
	  	objeto.setDataHora(resultadoLista.getString(pos++));  
	  	objeto.setFacebookId(resultadoLista.getString(pos++));  
	  	objeto.setQtdeClick(resultadoLista.getInt(pos++));  
	  	objeto.setMensagem(resultadoLista.getString(pos++));  
	  	objeto.setPrecoConsumidor(resultadoLista.getFloat(pos++));  
	  	objeto.setIdFacebookFanpageEp(resultadoLista.getInt(pos++));  
	  	objeto.setIdFacebookPerfilEp(resultadoLista.getInt(pos++));  
