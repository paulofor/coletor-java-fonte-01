...
public class FacebookProspectMontador   implements MontadorDaoI { 
    ...
    public  DCIObjetoDominio extraiRegistro( ResultadoLista resultadoLista )  throws  DaoException{
		...
		objeto = FabricaVo.criaFacebookProspect();
	...
	public  DCIObjetoDominio extraiRegistro( ResultadoLista resultadoLista  ,  DCIObjetoDominio entrada  ,  int pos )  throws  DaoException{
		FacebookProspect objeto;
		objeto = (FacebookProspect)entrada;
		  
	  	objeto.setIdFacebookProspect(resultadoLista.getInt(pos++));  
	  	objeto.setFacebookId(resultadoLista.getInt(pos++));
      	return objeto;
	}
