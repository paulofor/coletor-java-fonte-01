...
public  class OportunidadeDiaObjetoWs   { 
	...
	public void setUrlProduto( String dado ) {
      ...
      float _valorParcelaAtual;
	public float getValorParcelaAtual() {
		return _valorParcelaAtual;
	}
	public void setValorParcelaAtual( float dado ) {
		_valorParcelaAtual = dado;
	}
      float _valorParcelaAnterior;
	public float getValorParcelaAnterior() {
		return _valorParcelaAnterior;
	}
	public void setValorParcelaAnterior( float dado ) {
		_valorParcelaAnterior = dado;
	}
	...
	public void setQuantidadeParcelaAtual( long dado ) {
      ...
      float _valorConsumidorAtual;
	public float getValorConsumidorAtual() {
		return _valorConsumidorAtual;
	}
	public void setValorConsumidorAtual( float dado ) {
		_valorConsumidorAtual = dado;
	}
      float _valorConsumidorAnterior;
	public float getValorConsumidorAnterior() {
		return _valorConsumidorAnterior;
	}
	public void setValorConsumidorAnterior( float dado ) {
		_valorConsumidorAnterior = dado;
	}
      float _percentualAjusteAtual;
	public float getPercentualAjusteAtual() {
		return _percentualAjusteAtual;
	}
	public void setPercentualAjusteAtual( float dado ) {
		_percentualAjusteAtual = dado;
	}
      String _urlImagem;
	...
	public void setImagemLocal( String dado ) {
      ...
      long _quantidadeExibicao;
	public long getQuantidadeExibicao() {
		return _quantidadeExibicao;
	}
	public void setQuantidadeExibicao( long dado ) {
		_quantidadeExibicao = dado;
	}
