...
public abstract class CategoriaProdutoProdutoListaCallbackHtmlBase  extends CallbackParseHtml{

	protected CategoriaProdutoProdutoDadosParseBase dadosParse;
	protected boolean ligaColetaLista = false;
	protected List<CategoriaProdutoProduto> lista = null;
	protected CategoriaProdutoProduto corrente = null;
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		dadosParse = (CategoriaProdutoProdutoDadosParseBase) paramIDadosParse;
	}
	...
	public final void finalizacaoErro() {
		...
		//if (lista==null) throw new RuntimeException("objeto lista em CategoriaProdutoProdutoDetalheCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}

	@Override
	public final void finalizacaoOk() {
		//if (lista==null) throw new RuntimeException("objeto lista em CategoriaProdutoProdutoListaCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}
