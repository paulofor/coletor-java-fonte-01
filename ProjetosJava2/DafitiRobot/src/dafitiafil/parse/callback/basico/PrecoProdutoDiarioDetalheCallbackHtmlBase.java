...
public abstract class PrecoProdutoDiarioDetalheCallbackHtmlBase  extends CallbackParseHtml{
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		...
		ArquivoLog.getInstancia().salvaLog("PrecoProdutoDiario(detalhe):"  + dadosParse.displayLog(dadosParse.getItemDetalhe()));
	}
