...
public abstract class CategoriaProdutoProdutoDetalheCallbackHtmlBase  extends CallbackParseHtml{
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		...
		ArquivoLog.getInstancia().salvaLog("CategoriaProdutoProduto(detalhe):"  + dadosParse.displayLog(dadosParse.getItemDetalhe()));
	}
