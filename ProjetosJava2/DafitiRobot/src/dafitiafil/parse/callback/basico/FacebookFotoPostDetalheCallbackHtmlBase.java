...
public abstract class FacebookFotoPostDetalheCallbackHtmlBase  extends CallbackParseHtml{
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		...
		ArquivoLog.getInstancia().salvaLog("FacebookFotoPost(detalhe):"  + dadosParse.displayLog(dadosParse.getItemDetalhe()));
	}
