...
import dafitiafil.parse.dados.basico.PrecoProdutoDiarioDadosParseBase;
import dafitiafil.modelo.PrecoProdutoDiario;
import br.com.digicom.parse.log.ArquivoLog;

public abstract class PrecoProdutoDiarioListaCallbackHtmlBase  extends CallbackParseHtml{

	protected PrecoProdutoDiarioDadosParseBase dadosParse;
	protected boolean ligaColetaLista = false;
	protected List<PrecoProdutoDiario> lista = null;
	protected PrecoProdutoDiario corrente = null;
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		dadosParse = (PrecoProdutoDiarioDadosParseBase) paramIDadosParse;
	}
	...
	public final void finalizacaoErro() {
		...
		//if (lista==null) throw new RuntimeException("objeto lista em PrecoProdutoDiarioDetalheCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}

	@Override
	public final void finalizacaoOk() {
		//if (lista==null) throw new RuntimeException("objeto lista em PrecoProdutoDiarioListaCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}
