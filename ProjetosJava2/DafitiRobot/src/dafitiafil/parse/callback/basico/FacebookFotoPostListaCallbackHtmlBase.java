...
public abstract class FacebookFotoPostListaCallbackHtmlBase  extends CallbackParseHtml{

	protected FacebookFotoPostDadosParseBase dadosParse;
	protected boolean ligaColetaLista = false;
	protected List<FacebookFotoPost> lista = null;
	protected FacebookFotoPost corrente = null;
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		dadosParse = (FacebookFotoPostDadosParseBase) paramIDadosParse;
	}
	...
	public final void finalizacaoErro() {
		...
		//if (lista==null) throw new RuntimeException("objeto lista em FacebookFotoPostDetalheCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}

	@Override
	public final void finalizacaoOk() {
		//if (lista==null) throw new RuntimeException("objeto lista em FacebookFotoPostListaCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}
