...
public abstract class FacebookProspectListaCallbackHtmlBase  extends CallbackParseHtml{
	...
	protected FacebookProspect corrente = null;
	...
	public final void finalizacaoErro() {
		...
		//if (lista==null) throw new RuntimeException("objeto lista em FacebookProspectDetalheCallbackHtmlBase esta null");
