...
import dafitiafil.parse.callback.FacebookProspectListaCallbackHtml;
import dafitiafil.parse.callback.FacebookProspectDetalheCallbackHtml;
import dafitiafil.parse.dados.FacebookProspectDadosParse;
...
public class FacebookProspectRegraColecaoAdaptador  {
	...
	protected FacebookProspectDadosParse dadosParse = null;
	
	public FacebookProspectRegraColecaoAdaptador() {
		exec = new ExecutadorParse();
		//callbackLista = criaListaCallbackHtml();
		//callbackDetalhe = criaDetalheCallbackHtml();
		dadosParse = new FacebookProspectDadosParse();
	}
	...
	protected ICallbackParse criaListaCallbackHtml() {
		return new FacebookProspectListaCallbackHtml();
	}
	protected ICallbackParse criaDetalheCallbackHtml() {
		return new FacebookProspectDetalheCallbackHtml();
	}
	...
	protected void preparaDadosLista(FacebookProspectDadosParse dados) {
	}
	...
	public void atualizaDetalhe(DaoConexao conexao) throws DaoException {
		FacebookProspectDao daoFonte = DBB.getInstancia().getFacebookProspectDao(); // 
		daoFonte.setConexao(conexao);
		List<FacebookProspect> lista = daoFonte.ListaCorrente();
		Iterator<FacebookProspect> itLista = lista.iterator();
		while (itLista.hasNext()) {
			FacebookProspect corrente = itLista.next();
	...
	public final void atualizaDetalhe(FacebookProspect itemRaiz, DaoConexao conexao) throws DaoException {
	...
	protected void preparaDadosDetalhe(FacebookProspectDadosParse dados) {
	}
	...
	private void atualizaItens(DaoConexao conexao) throws DaoException {
		...
		ICallbackParse callback = new FacebookProspectListaCallbackHtml();
		FacebookProspectDadosParse dadosParse = new FacebookProspectDadosParse();
		dadosParse.setConexao(conexao);
