...
public class OportunidadeInteresseClienteMontador   implements MontadorDaoI { 
    ...
    public  DCIObjetoDominio extraiRegistro( ResultadoLista resultadoLista )  throws  DaoException{
		...
		objeto = FabricaVo.criaOportunidadeInteresseCliente();
	...
	public  DCIObjetoDominio extraiRegistro( ResultadoLista resultadoLista  ,  DCIObjetoDominio entrada  ,  int pos )  throws  DaoException{
		OportunidadeInteresseCliente objeto;
		objeto = (OportunidadeInteresseCliente)entrada;
		  
	  	objeto.setIdOportunidadeInteresseCliente(resultadoLista.getInt(pos++));  
	  	objeto.setIdProdutoClientePa(resultadoLista.getInt(pos++));
      	return objeto;
	}
