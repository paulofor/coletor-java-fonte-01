...
public class PalavraMontador   implements MontadorDaoI { 
	...
	public  DCIObjetoDominio extraiRegistro( ResultadoLista resultadoLista  ,  DCIObjetoDominio entrada  ,  int pos )  throws  DaoException{
		Palavra objeto;
		objeto = (Palavra)entrada;
		  
	  	objeto.setIdPalavra(resultadoLista.getInt(pos++));  
	  	objeto.setDescricao(resultadoLista.getString(pos++));  
	  	objeto.setComum(resultadoLista.getLogicoConvertido(pos++));
      	return objeto;
	}
