...
public class FacebookFanpageMontador   implements MontadorDaoI { 
    ...
    public  DCIObjetoDominio extraiRegistro( ResultadoLista resultadoLista )  throws  DaoException{
		...
		objeto = FabricaVo.criaFacebookFanpage();
	...
	public  DCIObjetoDominio extraiRegistro( ResultadoLista resultadoLista  ,  DCIObjetoDominio entrada  ,  int pos )  throws  DaoException{
		FacebookFanpage objeto;
		objeto = (FacebookFanpage)entrada;
		  
	  	objeto.setIdFacebookFanpage(resultadoLista.getInt(pos++));  
	  	objeto.setNome(resultadoLista.getString(pos++));  
	  	objeto.setCodigoFacebook(resultadoLista.getString(pos++));  
	  	objeto.setNomeUrl(resultadoLista.getString(pos++));  
	  	objeto.setQuantidadeDia(resultadoLista.getInt(pos++));  
	  	objeto.setIdFacebookPerfilPa(resultadoLista.getInt(pos++));  
	  	objeto.setIdAppProdutoD(resultadoLista.getInt(pos++));
      	return objeto;
	}
