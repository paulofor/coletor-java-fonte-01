...
public class CompartilhamentoProdutoMontador   implements MontadorDaoI { 
	...
	public  DCIObjetoDominio extraiRegistro( ResultadoLista resultadoLista  ,  DCIObjetoDominio entrada  ,  int pos )  throws  DaoException{
		CompartilhamentoProduto objeto;
		objeto = (CompartilhamentoProduto)entrada;
		  
	  	objeto.setIdCompartilhamentoProduto(resultadoLista.getInt(pos++));  
	  	objeto.setDataHora(resultadoLista.getString(pos++));  
	  	objeto.setIdUsuarioPa(resultadoLista.getInt(pos++));  
