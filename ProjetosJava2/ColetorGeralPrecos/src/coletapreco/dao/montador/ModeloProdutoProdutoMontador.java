...
public class ModeloProdutoProdutoMontador   implements MontadorDaoI { 
    ...
    public  DCIObjetoDominio extraiRegistro( ResultadoLista resultadoLista )  throws  DaoException{
		...
		objeto = FabricaVo.criaModeloProdutoProduto();
	...
	public  DCIObjetoDominio extraiRegistro( ResultadoLista resultadoLista  ,  DCIObjetoDominio entrada  ,  int pos )  throws  DaoException{
		ModeloProdutoProduto objeto;
		objeto = (ModeloProdutoProduto)entrada;
		  
	  	objeto.setIdModeloProdutoProduto(resultadoLista.getInt(pos++));  
	  	objeto.setIdModeloProdutoRa(resultadoLista.getInt(pos++));  
