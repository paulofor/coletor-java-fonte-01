...
public class CategoriaLojaProdutoMontador   implements MontadorDaoI { 
	...
	public  DCIObjetoDominio extraiRegistro( ResultadoLista resultadoLista  ,  DCIObjetoDominio entrada  ,  int pos )  throws  DaoException{
		CategoriaLojaProduto objeto;
		objeto = (CategoriaLojaProduto)entrada;
		  
	  	objeto.setIdCategoriaLojaProduto(resultadoLista.getInt(pos++));  
	  	objeto.setDataUltimaVisita(resultadoLista.getString(pos++));  
	  	objeto.setIdCategoriaLojaRa(resultadoLista.getInt(pos++));  
