...
public class CategoriaLojaMontador   implements MontadorDaoI { 
    ...
    public  DCIObjetoDominio extraiRegistro( ResultadoLista resultadoLista )  throws  DaoException{
		...
		objeto = FabricaVo.criaCategoriaLoja();
	...
	public  DCIObjetoDominio extraiRegistro( ResultadoLista resultadoLista  ,  DCIObjetoDominio entrada  ,  int pos )  throws  DaoException{
		CategoriaLoja objeto;
		objeto = (CategoriaLoja)entrada;
		  
	  	objeto.setIdCategoriaLoja(resultadoLista.getInt(pos++));  
	  	...
	  	objeto.setIdCategoriaLojaF(resultadoLista.getInt(pos++));  
	  	objeto.setIdNaturezaProdutoRa(resultadoLista.getInt(pos++));  
	  	objeto.setIdLojaVirtualPa(resultadoLista.getInt(pos++));
      	return objeto;
	}
