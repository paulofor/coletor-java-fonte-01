...
public  class FabricaVo   {
	...
	public static PrecoDiarioCliente criaPrecoDiarioCliente()  {
          return new PrecoDiarioClienteVo();
	}
	public static CompartilhamentoProduto criaCompartilhamentoProduto()  {
          return new CompartilhamentoProdutoVo();
	}
	public static OportunidadeInteresseCliente criaOportunidadeInteresseCliente()  {
          return new OportunidadeInteresseClienteVo();
	}
