...
import coletapreco.parse.callback.UsuarioListaCallbackHtml;
import coletapreco.parse.callback.UsuarioDetalheCallbackHtml;
import coletapreco.parse.dados.UsuarioDadosParse;
...
public abstract class UsuarioRegraColecaoAdaptador  {
	...
	private ICallbackParse getCallbackLista() {
		...
		if (callbackLista==null) {
			System.out.println("Usuario ID:" + this.getItemRaiz().getIdObj() + " nao possui Callback em " + this.getClass().getSimpleName() + ".criaListaCallbackHtml()");
		}
	...
	private ICallbackParse getCallbackDetalhe() {
		...
		if (callbackDetalhe==null) {
			System.out.println("Usuario ID:" + this.getItemRaiz().getIdObj() + " nao possui Callback em " + this.getClass().getSimpleName() + ".criaDetalheCallbackHtml()");
		}
