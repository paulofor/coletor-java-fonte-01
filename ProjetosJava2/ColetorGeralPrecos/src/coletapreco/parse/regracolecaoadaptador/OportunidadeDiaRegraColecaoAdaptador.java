...
import coletapreco.parse.callback.OportunidadeDiaListaCallbackHtml;
import coletapreco.parse.callback.OportunidadeDiaDetalheCallbackHtml;
import coletapreco.parse.dados.OportunidadeDiaDadosParse;
...
public abstract class OportunidadeDiaRegraColecaoAdaptador  {
	...
	private ICallbackParse getCallbackLista() {
		...
		if (callbackLista==null) {
			System.out.println("OportunidadeDia ID:" + this.getItemRaiz().getIdObj() + " nao possui Callback em " + this.getClass().getSimpleName() + ".criaListaCallbackHtml()");
		}
	...
	private ICallbackParse getCallbackDetalhe() {
		...
		if (callbackDetalhe==null) {
			System.out.println("OportunidadeDia ID:" + this.getItemRaiz().getIdObj() + " nao possui Callback em " + this.getClass().getSimpleName() + ".criaDetalheCallbackHtml()");
		}
	...
	public OportunidadeDia getItemRaiz() {
