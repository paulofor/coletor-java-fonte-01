...
import coletapreco.parse.dados.basico.DispositivoUsuarioDadosParseBase;
import coletapreco.modelo.DispositivoUsuario;
import br.com.digicom.parse.log.ArquivoLog;

public abstract class DispositivoUsuarioListaCallbackHtmlBase  extends CallbackParseHtml{

	protected DispositivoUsuarioDadosParseBase dadosParse;
	protected boolean ligaColetaLista = false;
	protected List<DispositivoUsuario> lista = null;
	protected DispositivoUsuario corrente = null;
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		dadosParse = (DispositivoUsuarioDadosParseBase) paramIDadosParse;
	}
	...
	public final void finalizacaoErro() {
		...
		//if (lista==null) throw new RuntimeException("objeto lista em DispositivoUsuarioDetalheCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}

	@Override
	public final void finalizacaoOk() {
		//if (lista==null) throw new RuntimeException("objeto lista em DispositivoUsuarioListaCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}
