...
public abstract class LojaVirtualDetalheCallbackHtmlBase  extends CallbackParseHtml{

	protected LojaVirtualDadosParseBase dadosParse;
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		dadosParse = (LojaVirtualDadosParseBase) paramIDadosParse;
		ArquivoLog.getInstancia().salvaLog("LojaVirtual(detalhe):"  + dadosParse.displayLog(dadosParse.getItemDetalhe()));
	}
	...
	public final void finalizacaoOk() {
		//if (lista==null) throw new RuntimeException("objeto lista em LojaVirtualListaCallbackHtmlBase esta null");
		finalizaObjeto();
	...
	private void limpaListasInternas() {
		...
		this.dadosParse.getItemDetalhe().setListaProduto_Possui(null);
 	
		this.dadosParse.getItemDetalhe().setListaCategoriaLoja_Possui(null);
 	
		this.dadosParse.getItemDetalhe().setListaLojaNatureza_Oferece(null);
