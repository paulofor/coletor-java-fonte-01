...
import coletapreco.parse.dados.basico.UsuarioPesquisaDadosParseBase;
import coletapreco.modelo.UsuarioPesquisa;
import br.com.digicom.parse.log.ArquivoLog;

public abstract class UsuarioPesquisaListaCallbackHtmlBase  extends CallbackParseHtml{

	protected UsuarioPesquisaDadosParseBase dadosParse;
	protected boolean ligaColetaLista = false;
	protected List<UsuarioPesquisa> lista = null;
	protected UsuarioPesquisa corrente = null;
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		dadosParse = (UsuarioPesquisaDadosParseBase) paramIDadosParse;
	}
	...
	public final void finalizacaoErro() {
		...
		//if (lista==null) throw new RuntimeException("objeto lista em UsuarioPesquisaDetalheCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}

	@Override
	public final void finalizacaoOk() {
		//if (lista==null) throw new RuntimeException("objeto lista em UsuarioPesquisaListaCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}
