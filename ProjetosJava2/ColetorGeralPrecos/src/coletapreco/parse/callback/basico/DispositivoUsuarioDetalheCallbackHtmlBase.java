...
public abstract class DispositivoUsuarioDetalheCallbackHtmlBase  extends CallbackParseHtml{
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		...
		ArquivoLog.getInstancia().salvaLog("DispositivoUsuario(detalhe):"  + dadosParse.displayLog(dadosParse.getItemDetalhe()));
	}
