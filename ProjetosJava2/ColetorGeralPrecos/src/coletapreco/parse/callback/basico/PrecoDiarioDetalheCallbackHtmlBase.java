...
public abstract class PrecoDiarioDetalheCallbackHtmlBase  extends CallbackParseHtml{
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		...
		ArquivoLog.getInstancia().salvaLog("PrecoDiario(detalhe):"  + dadosParse.displayLog(dadosParse.getItemDetalhe()));
	}
