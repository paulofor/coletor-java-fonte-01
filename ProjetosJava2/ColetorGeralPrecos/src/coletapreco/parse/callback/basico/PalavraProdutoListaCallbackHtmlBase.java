...
import coletapreco.parse.dados.basico.PalavraProdutoDadosParseBase;
import coletapreco.modelo.PalavraProduto;
import br.com.digicom.parse.log.ArquivoLog;

public abstract class PalavraProdutoListaCallbackHtmlBase  extends CallbackParseHtml{

	protected PalavraProdutoDadosParseBase dadosParse;
	protected boolean ligaColetaLista = false;
	protected List<PalavraProduto> lista = null;
	protected PalavraProduto corrente = null;
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		dadosParse = (PalavraProdutoDadosParseBase) paramIDadosParse;
	}
	...
	public final void finalizacaoErro() {
		...
		//if (lista==null) throw new RuntimeException("objeto lista em PalavraProdutoDetalheCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}

	@Override
	public final void finalizacaoOk() {
		//if (lista==null) throw new RuntimeException("objeto lista em PalavraProdutoListaCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}
