...
import coletapreco.parse.dados.basico.LojaNaturezaDadosParseBase;
import coletapreco.modelo.LojaNatureza;
import br.com.digicom.parse.log.ArquivoLog;

public abstract class LojaNaturezaListaCallbackHtmlBase  extends CallbackParseHtml{

	protected LojaNaturezaDadosParseBase dadosParse;
	protected boolean ligaColetaLista = false;
	protected List<LojaNatureza> lista = null;
	protected LojaNatureza corrente = null;
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		dadosParse = (LojaNaturezaDadosParseBase) paramIDadosParse;
	}
	...
	public final void finalizacaoErro() {
		...
		//if (lista==null) throw new RuntimeException("objeto lista em LojaNaturezaDetalheCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}

	@Override
	public final void finalizacaoOk() {
		//if (lista==null) throw new RuntimeException("objeto lista em LojaNaturezaListaCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}
