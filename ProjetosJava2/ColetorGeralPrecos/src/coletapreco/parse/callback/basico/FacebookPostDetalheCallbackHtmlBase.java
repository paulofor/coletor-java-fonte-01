...
import coletapreco.parse.dados.basico.FacebookPostDadosParseBase;
import coletapreco.modelo.FacebookPost;
import coletapreco.log.ArquivoLog;


public abstract class FacebookPostDetalheCallbackHtmlBase  extends CallbackParseHtml{

	protected FacebookPostDadosParseBase dadosParse;
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		dadosParse = (FacebookPostDadosParseBase) paramIDadosParse;
		ArquivoLog.getInstancia().salvaLog("FacebookPost(detalhe):"  + dadosParse.displayLog(dadosParse.getItemDetalhe()));
	}
	...
	public final void finalizacaoOk() {
		//if (lista==null) throw new RuntimeException("objeto lista em FacebookPostListaCallbackHtmlBase esta null");
		finalizaObjeto();
	...
	private void limpaListasInternas() {
		...
		this.dadosParse.getItemDetalhe().setListaFacebookPostPerformance_Gera(null);
