...
import coletapreco.parse.dados.basico.PrecoDiarioDadosParseBase;
import coletapreco.modelo.PrecoDiario;
import br.com.digicom.parse.log.ArquivoLog;

public abstract class PrecoDiarioListaCallbackHtmlBase  extends CallbackParseHtml{

	protected PrecoDiarioDadosParseBase dadosParse;
	protected boolean ligaColetaLista = false;
	protected List<PrecoDiario> lista = null;
	protected PrecoDiario corrente = null;
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		dadosParse = (PrecoDiarioDadosParseBase) paramIDadosParse;
	}
	...
	public final void finalizacaoErro() {
		...
		//if (lista==null) throw new RuntimeException("objeto lista em PrecoDiarioDetalheCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}

	@Override
	public final void finalizacaoOk() {
		//if (lista==null) throw new RuntimeException("objeto lista em PrecoDiarioListaCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}
