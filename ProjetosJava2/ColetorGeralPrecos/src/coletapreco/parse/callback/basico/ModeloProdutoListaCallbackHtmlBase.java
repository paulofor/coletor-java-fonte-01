...
public abstract class ModeloProdutoListaCallbackHtmlBase  extends CallbackParseHtml{
	...
	protected ModeloProduto corrente = null;
	...
	public final void finalizacaoErro() {
		...
		//if (lista==null) throw new RuntimeException("objeto lista em ModeloProdutoDetalheCallbackHtmlBase esta null");
