...
import coletapreco.parse.dados.basico.FacebookPerfilDadosParseBase;
import coletapreco.modelo.FacebookPerfil;
import coletapreco.log.ArquivoLog;


public abstract class FacebookPerfilDetalheCallbackHtmlBase  extends CallbackParseHtml{
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		...
		ArquivoLog.getInstancia().salvaLog("FacebookPerfil(detalhe):"  + dadosParse.displayLog(dadosParse.getItemDetalhe()));
	}
