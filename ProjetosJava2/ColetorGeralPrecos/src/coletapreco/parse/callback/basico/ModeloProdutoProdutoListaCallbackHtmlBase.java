...
import coletapreco.parse.dados.basico.ModeloProdutoProdutoDadosParseBase;
import coletapreco.modelo.ModeloProdutoProduto;
import br.com.digicom.parse.log.ArquivoLog;

public abstract class ModeloProdutoProdutoListaCallbackHtmlBase  extends CallbackParseHtml{

	protected ModeloProdutoProdutoDadosParseBase dadosParse;
	protected boolean ligaColetaLista = false;
	protected List<ModeloProdutoProduto> lista = null;
	protected ModeloProdutoProduto corrente = null;
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		dadosParse = (ModeloProdutoProdutoDadosParseBase) paramIDadosParse;
	}
	...
	public final void finalizacaoErro() {
		...
		//if (lista==null) throw new RuntimeException("objeto lista em ModeloProdutoProdutoDetalheCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}

	@Override
	public final void finalizacaoOk() {
		//if (lista==null) throw new RuntimeException("objeto lista em ModeloProdutoProdutoListaCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}
