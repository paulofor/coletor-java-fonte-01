...
public abstract class LojaVirtualListaCallbackHtmlBase  extends CallbackParseHtml{
	...
	protected LojaVirtual corrente = null;
	...
	public final void finalizacaoErro() {
		...
		//if (lista==null) throw new RuntimeException("objeto lista em LojaVirtualDetalheCallbackHtmlBase esta null");
