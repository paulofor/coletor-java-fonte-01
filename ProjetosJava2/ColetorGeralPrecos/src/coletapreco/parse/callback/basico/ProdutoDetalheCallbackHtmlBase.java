...
public abstract class ProdutoDetalheCallbackHtmlBase  extends CallbackParseHtml{
	...
	private void limpaListasInternas() {
		...
		this.dadosParse.getItemDetalhe().setListaPrecoDiario_Possui(null);
		...
		this.dadosParse.getItemDetalhe().setListaFacebookPost_DivulgadoPor(null);
 	
		this.dadosParse.getItemDetalhe().setListaCompartilhamentoProduto_Gerou(null);
