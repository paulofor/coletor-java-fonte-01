...
public abstract class FacebookPostListaCallbackHtmlBase  extends CallbackParseHtml{
	...
	protected FacebookPost corrente = null;
	...
	public final void finalizacaoErro() {
		...
		//if (lista==null) throw new RuntimeException("objeto lista em FacebookPostDetalheCallbackHtmlBase esta null");
