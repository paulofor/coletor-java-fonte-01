...
import coletapreco.parse.dados.basico.CategoriaLojaProdutoDadosParseBase;
import coletapreco.modelo.CategoriaLojaProduto;
import br.com.digicom.parse.log.ArquivoLog;

public abstract class CategoriaLojaProdutoListaCallbackHtmlBase  extends CallbackParseHtml{

	protected CategoriaLojaProdutoDadosParseBase dadosParse;
	protected boolean ligaColetaLista = false;
	protected List<CategoriaLojaProduto> lista = null;
	protected CategoriaLojaProduto corrente = null;
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		dadosParse = (CategoriaLojaProdutoDadosParseBase) paramIDadosParse;
	}
	...
	public final void finalizacaoErro() {
		...
		//if (lista==null) throw new RuntimeException("objeto lista em CategoriaLojaProdutoDetalheCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}

	@Override
	public final void finalizacaoOk() {
		//if (lista==null) throw new RuntimeException("objeto lista em CategoriaLojaProdutoListaCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}
