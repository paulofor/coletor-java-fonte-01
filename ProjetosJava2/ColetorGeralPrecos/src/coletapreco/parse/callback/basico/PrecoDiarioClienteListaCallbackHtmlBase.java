...
import coletapreco.parse.dados.basico.PrecoDiarioClienteDadosParseBase;
import coletapreco.modelo.PrecoDiarioCliente;
import br.com.digicom.parse.log.ArquivoLog;

public abstract class PrecoDiarioClienteListaCallbackHtmlBase  extends CallbackParseHtml{

	protected PrecoDiarioClienteDadosParseBase dadosParse;
	protected boolean ligaColetaLista = false;
	protected List<PrecoDiarioCliente> lista = null;
	protected PrecoDiarioCliente corrente = null;
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		dadosParse = (PrecoDiarioClienteDadosParseBase) paramIDadosParse;
	}
	...
	public final void finalizacaoErro() {
		...
		//if (lista==null) throw new RuntimeException("objeto lista em PrecoDiarioClienteDetalheCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}

	@Override
	public final void finalizacaoOk() {
		//if (lista==null) throw new RuntimeException("objeto lista em PrecoDiarioClienteListaCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}
