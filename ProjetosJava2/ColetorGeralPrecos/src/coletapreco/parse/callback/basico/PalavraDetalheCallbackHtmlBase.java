...
import coletapreco.parse.dados.basico.PalavraDadosParseBase;
import coletapreco.modelo.Palavra;
import coletapreco.log.ArquivoLog;


public abstract class PalavraDetalheCallbackHtmlBase  extends CallbackParseHtml{

	protected PalavraDadosParseBase dadosParse;
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		dadosParse = (PalavraDadosParseBase) paramIDadosParse;
		ArquivoLog.getInstancia().salvaLog("Palavra(detalhe):"  + dadosParse.displayLog(dadosParse.getItemDetalhe()));
	}
	...
	public final void finalizacaoOk() {
		//if (lista==null) throw new RuntimeException("objeto lista em PalavraListaCallbackHtmlBase esta null");
		finalizaObjeto();
	...
	private void limpaListasInternas() {
		...
		this.dadosParse.getItemDetalhe().setListaPalavraProduto_Possui(null);
