...
import coletapreco.parse.dados.basico.ModeloProdutoDadosParseBase;
import coletapreco.modelo.ModeloProduto;
import coletapreco.log.ArquivoLog;


public abstract class ModeloProdutoDetalheCallbackHtmlBase  extends CallbackParseHtml{

	protected ModeloProdutoDadosParseBase dadosParse;
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		dadosParse = (ModeloProdutoDadosParseBase) paramIDadosParse;
		ArquivoLog.getInstancia().salvaLog("ModeloProduto(detalhe):"  + dadosParse.displayLog(dadosParse.getItemDetalhe()));
	}
	...
	public final void finalizacaoOk() {
		//if (lista==null) throw new RuntimeException("objeto lista em ModeloProdutoListaCallbackHtmlBase esta null");
		finalizaObjeto();
	...
	private void limpaListasInternas() {
		...
		this.dadosParse.getItemDetalhe().setListaModeloProdutoProduto_ReferenteA(null);
