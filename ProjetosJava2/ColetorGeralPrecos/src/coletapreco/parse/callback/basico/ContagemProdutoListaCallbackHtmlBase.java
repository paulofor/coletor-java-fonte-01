...
import coletapreco.parse.dados.basico.ContagemProdutoDadosParseBase;
import coletapreco.modelo.ContagemProduto;
import br.com.digicom.parse.log.ArquivoLog;

public abstract class ContagemProdutoListaCallbackHtmlBase  extends CallbackParseHtml{

	protected ContagemProdutoDadosParseBase dadosParse;
	protected boolean ligaColetaLista = false;
	protected List<ContagemProduto> lista = null;
	protected ContagemProduto corrente = null;
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		dadosParse = (ContagemProdutoDadosParseBase) paramIDadosParse;
	}
	...
	public final void finalizacaoErro() {
		...
		//if (lista==null) throw new RuntimeException("objeto lista em ContagemProdutoDetalheCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}

	@Override
	public final void finalizacaoOk() {
		//if (lista==null) throw new RuntimeException("objeto lista em ContagemProdutoListaCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}
