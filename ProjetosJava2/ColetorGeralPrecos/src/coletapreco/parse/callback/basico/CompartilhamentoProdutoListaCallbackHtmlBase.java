...
import coletapreco.parse.dados.basico.CompartilhamentoProdutoDadosParseBase;
import coletapreco.modelo.CompartilhamentoProduto;
import br.com.digicom.parse.log.ArquivoLog;

public abstract class CompartilhamentoProdutoListaCallbackHtmlBase  extends CallbackParseHtml{

	protected CompartilhamentoProdutoDadosParseBase dadosParse;
	protected boolean ligaColetaLista = false;
	protected List<CompartilhamentoProduto> lista = null;
	protected CompartilhamentoProduto corrente = null;
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		dadosParse = (CompartilhamentoProdutoDadosParseBase) paramIDadosParse;
	}
	...
	public final void finalizacaoErro() {
		...
		//if (lista==null) throw new RuntimeException("objeto lista em CompartilhamentoProdutoDetalheCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}

	@Override
	public final void finalizacaoOk() {
		//if (lista==null) throw new RuntimeException("objeto lista em CompartilhamentoProdutoListaCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}
