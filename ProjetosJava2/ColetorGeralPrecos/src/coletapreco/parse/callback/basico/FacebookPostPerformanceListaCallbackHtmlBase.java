...
import coletapreco.parse.dados.basico.FacebookPostPerformanceDadosParseBase;
import coletapreco.modelo.FacebookPostPerformance;
import br.com.digicom.parse.log.ArquivoLog;

public abstract class FacebookPostPerformanceListaCallbackHtmlBase  extends CallbackParseHtml{

	protected FacebookPostPerformanceDadosParseBase dadosParse;
	protected boolean ligaColetaLista = false;
	protected List<FacebookPostPerformance> lista = null;
	protected FacebookPostPerformance corrente = null;
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		dadosParse = (FacebookPostPerformanceDadosParseBase) paramIDadosParse;
	}
	...
	public final void finalizacaoErro() {
		...
		//if (lista==null) throw new RuntimeException("objeto lista em FacebookPostPerformanceDetalheCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}

	@Override
	public final void finalizacaoOk() {
		//if (lista==null) throw new RuntimeException("objeto lista em FacebookPostPerformanceListaCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}
