...
import coletapreco.parse.dados.basico.PrecoProdutoDadosParseBase;
import coletapreco.modelo.PrecoProduto;
import coletapreco.log.ArquivoLog;


public abstract class PrecoProdutoDetalheCallbackHtmlBase  extends CallbackParseHtml{
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		...
		ArquivoLog.getInstancia().salvaLog("PrecoProduto(detalhe):"  + dadosParse.displayLog(dadosParse.getItemDetalhe()));
	}
