...
import coletapreco.parse.dados.basico.InteresseProdutoDadosParseBase;
import coletapreco.modelo.InteresseProduto;
import br.com.digicom.parse.log.ArquivoLog;

public abstract class InteresseProdutoListaCallbackHtmlBase  extends CallbackParseHtml{

	protected InteresseProdutoDadosParseBase dadosParse;
	protected boolean ligaColetaLista = false;
	protected List<InteresseProduto> lista = null;
	protected InteresseProduto corrente = null;
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		dadosParse = (InteresseProdutoDadosParseBase) paramIDadosParse;
	}
	...
	public final void finalizacaoErro() {
		...
		//if (lista==null) throw new RuntimeException("objeto lista em InteresseProdutoDetalheCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}

	@Override
	public final void finalizacaoOk() {
		//if (lista==null) throw new RuntimeException("objeto lista em InteresseProdutoListaCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}
