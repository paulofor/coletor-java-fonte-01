...
public abstract class ProdutoClienteListaCallbackHtmlBase  extends CallbackParseHtml{
	...
	protected ProdutoCliente corrente = null;
	...
	public final void finalizacaoErro() {
		...
		//if (lista==null) throw new RuntimeException("objeto lista em ProdutoClienteDetalheCallbackHtmlBase esta null");
