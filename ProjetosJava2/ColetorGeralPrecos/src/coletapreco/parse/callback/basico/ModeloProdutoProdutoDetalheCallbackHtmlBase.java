...
public abstract class ModeloProdutoProdutoDetalheCallbackHtmlBase  extends CallbackParseHtml{
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		...
		ArquivoLog.getInstancia().salvaLog("ModeloProdutoProduto(detalhe):"  + dadosParse.displayLog(dadosParse.getItemDetalhe()));
	}
