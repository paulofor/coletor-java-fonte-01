...
public abstract class NaturezaProdutoListaCallbackHtmlBase  extends CallbackParseHtml{
	...
	protected NaturezaProduto corrente = null;
	...
	public final void finalizacaoErro() {
		...
		//if (lista==null) throw new RuntimeException("objeto lista em NaturezaProdutoDetalheCallbackHtmlBase esta null");
