...
public class LojaVirtualAmericanasDetalheCallback extends
	...
	public LojaVirtualAmericanasDetalheCallback() {
		//this.setDebug();
	...
	private void insereObjetoLista() {
		...
		if (urlCategoria.indexOf("http")==-1) {
			urlCategoria = "http://www.americanas.com.br" + urlCategoria;
		}
