...
public class CategoriaLojaExtraDetalheCallback  extends CategoriaLojaDetalheCallbackHtml {
	...
	public CategoriaLojaExtraDetalheCallback() {
		//this.setDebug();
	...
	protected void handleUrl(String url, String classe, String titulo, String id) {
		...
		//if ("next".equals(this.getUltClasse2())) {
		//	loop = true;
		///	urlCorrente =  url;
		//}
	}
