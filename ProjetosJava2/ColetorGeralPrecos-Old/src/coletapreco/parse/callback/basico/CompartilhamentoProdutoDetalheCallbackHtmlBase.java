...
public abstract class CompartilhamentoProdutoDetalheCallbackHtmlBase  extends CallbackParseHtml{
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		...
		ArquivoLog.getInstancia().salvaLog("CompartilhamentoProduto(detalhe):"  + dadosParse.displayLog(dadosParse.getItemDetalhe()));
	}
