...
import coletapreco.parse.dados.basico.ProdutoClienteDadosParseBase;
import coletapreco.modelo.ProdutoCliente;
import coletapreco.log.ArquivoLog;


public abstract class ProdutoClienteDetalheCallbackHtmlBase  extends CallbackParseHtml{

	protected ProdutoClienteDadosParseBase dadosParse;
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		dadosParse = (ProdutoClienteDadosParseBase) paramIDadosParse;
		ArquivoLog.getInstancia().salvaLog("ProdutoCliente(detalhe):"  + dadosParse.displayLog(dadosParse.getItemDetalhe()));
	}
	...
	public final void finalizacaoOk() {
		//if (lista==null) throw new RuntimeException("objeto lista em ProdutoClienteListaCallbackHtmlBase esta null");
		finalizaObjeto();
	...
	private void limpaListasInternas() {
		...
		this.dadosParse.getItemDetalhe().setListaInteresseProduto_Possui(null);
 	
		this.dadosParse.getItemDetalhe().setListaPrecoDiarioCliente_Possui(null);
 	
		this.dadosParse.getItemDetalhe().setListaOportunidadeInteresseCliente_Possui(null);
