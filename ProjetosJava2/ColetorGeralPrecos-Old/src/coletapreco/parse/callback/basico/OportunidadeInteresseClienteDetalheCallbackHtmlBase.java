...
public abstract class OportunidadeInteresseClienteDetalheCallbackHtmlBase  extends CallbackParseHtml{
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		...
		ArquivoLog.getInstancia().salvaLog("OportunidadeInteresseCliente(detalhe):"  + dadosParse.displayLog(dadosParse.getItemDetalhe()));
	}
