...
public abstract class InteresseProdutoDetalheCallbackHtmlBase  extends CallbackParseHtml{
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		...
		ArquivoLog.getInstancia().salvaLog("InteresseProduto(detalhe):"  + dadosParse.displayLog(dadosParse.getItemDetalhe()));
	}
