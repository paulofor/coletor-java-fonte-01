...
import coletapreco.parse.dados.basico.OportunidadeDiaDadosParseBase;
import coletapreco.modelo.OportunidadeDia;
import coletapreco.log.ArquivoLog;


public abstract class OportunidadeDiaDetalheCallbackHtmlBase  extends CallbackParseHtml{
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		...
		ArquivoLog.getInstancia().salvaLog("OportunidadeDia(detalhe):"  + dadosParse.displayLog(dadosParse.getItemDetalhe()));
	}
