...
import coletapreco.parse.dados.basico.MarcaDadosParseBase;
import coletapreco.modelo.Marca;
import coletapreco.log.ArquivoLog;


public abstract class MarcaDetalheCallbackHtmlBase  extends CallbackParseHtml{
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		...
		ArquivoLog.getInstancia().salvaLog("Marca(detalhe):"  + dadosParse.displayLog(dadosParse.getItemDetalhe()));
	}
	...
	private void limpaListasInternas() {
		...
		this.dadosParse.getItemDetalhe().setListaProduto_ReferenteA(null);
