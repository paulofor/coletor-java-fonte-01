...
import coletapreco.parse.dados.basico.PalavraChavePesquisaDadosParseBase;
import coletapreco.modelo.PalavraChavePesquisa;
import coletapreco.log.ArquivoLog;


public abstract class PalavraChavePesquisaDetalheCallbackHtmlBase  extends CallbackParseHtml{

	protected PalavraChavePesquisaDadosParseBase dadosParse;
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		dadosParse = (PalavraChavePesquisaDadosParseBase) paramIDadosParse;
		ArquivoLog.getInstancia().salvaLog("PalavraChavePesquisa(detalhe):"  + dadosParse.displayLog(dadosParse.getItemDetalhe()));
	}
	...
	public final void finalizacaoOk() {
		//if (lista==null) throw new RuntimeException("objeto lista em PalavraChavePesquisaListaCallbackHtmlBase esta null");
		finalizaObjeto();
	...
	private void limpaListasInternas() {
		...
		this.dadosParse.getItemDetalhe().setListaProdutoCliente_Gerou(null);
