...
public abstract class CategoriaLojaDetalheCallbackHtmlBase  extends CallbackParseHtml{

	protected CategoriaLojaDadosParseBase dadosParse;
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		dadosParse = (CategoriaLojaDadosParseBase) paramIDadosParse;
		ArquivoLog.getInstancia().salvaLog("CategoriaLoja(detalhe):"  + dadosParse.displayLog(dadosParse.getItemDetalhe()));
	}
	...
	private void limpaListasInternas() {
		...
		this.dadosParse.getItemDetalhe().setListaCategoriaLojaProduto_Possui(null);
 	
		this.dadosParse.getItemDetalhe().setListaCategoriaLoja_Filho(null);
