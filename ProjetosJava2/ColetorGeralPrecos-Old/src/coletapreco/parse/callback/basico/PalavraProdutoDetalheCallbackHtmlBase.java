...
public abstract class PalavraProdutoDetalheCallbackHtmlBase  extends CallbackParseHtml{
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		...
		ArquivoLog.getInstancia().salvaLog("PalavraProduto(detalhe):"  + dadosParse.displayLog(dadosParse.getItemDetalhe()));
	}
