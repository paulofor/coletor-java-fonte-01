...
public abstract class CategoriaLojaListaCallbackHtmlBase  extends CallbackParseHtml{
	...
	protected CategoriaLoja corrente = null;
	...
	public final void finalizacaoErro() {
		...
		//if (lista==null) throw new RuntimeException("objeto lista em CategoriaLojaDetalheCallbackHtmlBase esta null");
