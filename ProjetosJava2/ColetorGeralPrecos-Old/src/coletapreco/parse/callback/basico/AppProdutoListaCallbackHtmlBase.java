...
public abstract class AppProdutoListaCallbackHtmlBase  extends CallbackParseHtml{
	...
	public final void finalizacaoErro() {
		...
		//if (lista==null) throw new RuntimeException("objeto lista em AppProdutoDetalheCallbackHtmlBase esta null");
