...
import coletapreco.parse.dados.basico.OportunidadeInteresseClienteDadosParseBase;
import coletapreco.modelo.OportunidadeInteresseCliente;
import br.com.digicom.parse.log.ArquivoLog;

public abstract class OportunidadeInteresseClienteListaCallbackHtmlBase  extends CallbackParseHtml{

	protected OportunidadeInteresseClienteDadosParseBase dadosParse;
	protected boolean ligaColetaLista = false;
	protected List<OportunidadeInteresseCliente> lista = null;
	protected OportunidadeInteresseCliente corrente = null;
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		dadosParse = (OportunidadeInteresseClienteDadosParseBase) paramIDadosParse;
	}
	...
	public final void finalizacaoErro() {
		...
		//if (lista==null) throw new RuntimeException("objeto lista em OportunidadeInteresseClienteDetalheCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}

	@Override
	public final void finalizacaoOk() {
		//if (lista==null) throw new RuntimeException("objeto lista em OportunidadeInteresseClienteListaCallbackHtmlBase esta null");
		dadosParse.finalizacaoOkLista();
	}
