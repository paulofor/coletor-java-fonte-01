...
public abstract class PrecoDiarioClienteDetalheCallbackHtmlBase  extends CallbackParseHtml{
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		...
		ArquivoLog.getInstancia().salvaLog("PrecoDiarioCliente(detalhe):"  + dadosParse.displayLog(dadosParse.getItemDetalhe()));
	}
