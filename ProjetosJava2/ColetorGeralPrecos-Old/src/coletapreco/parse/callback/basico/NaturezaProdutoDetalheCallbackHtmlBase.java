package coletapreco.parse.callback.basico;
...
import coletapreco.parse.dados.basico.NaturezaProdutoDadosParseBase;
import coletapreco.modelo.NaturezaProduto;
import coletapreco.log.ArquivoLog;


public abstract class NaturezaProdutoDetalheCallbackHtmlBase  extends CallbackParseHtml{

	protected NaturezaProdutoDadosParseBase dadosParse;
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		dadosParse = (NaturezaProdutoDadosParseBase) paramIDadosParse;
		ArquivoLog.getInstancia().salvaLog("NaturezaProduto(detalhe):"  + dadosParse.displayLog(dadosParse.getItemDetalhe()));
	}
	...
	public final void finalizacaoOk() {
		//if (lista==null) throw new RuntimeException("objeto lista em NaturezaProdutoListaCallbackHtmlBase esta null");
		finalizaObjeto();
	...
	private void limpaListasInternas() {
		...
		this.dadosParse.getItemDetalhe().setListaCategoriaLoja_Possui(null);
 	
		this.dadosParse.getItemDetalhe().setListaLojaNatureza_Encontrada(null);
 	
		this.dadosParse.getItemDetalhe().setListaOportunidadeDia_Possui(null);
 	
		this.dadosParse.getItemDetalhe().setListaUsuarioPesquisa_PesquisadoPor(null);
 	
		this.dadosParse.getItemDetalhe().setListaContagemProduto_Possui(null);
 	
		this.dadosParse.getItemDetalhe().setListaPalavraChavePesquisa_PodePesquisar(null);
 	
		this.dadosParse.getItemDetalhe().setListaProdutoCliente_Possui(null);
