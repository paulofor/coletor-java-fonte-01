...
public abstract class FacebookPostPerformanceDetalheCallbackHtmlBase  extends CallbackParseHtml{
	...
	public final void setDados(IDadosParse paramIDadosParse) {
		...
		ArquivoLog.getInstancia().salvaLog("FacebookPostPerformance(detalhe):"  + dadosParse.displayLog(dadosParse.getItemDetalhe()));
	}
