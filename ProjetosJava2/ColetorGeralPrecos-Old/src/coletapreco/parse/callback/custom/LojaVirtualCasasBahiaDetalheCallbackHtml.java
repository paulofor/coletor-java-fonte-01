...
public class LojaVirtualCasasBahiaDetalheCallbackHtml extends LojaVirtualDetalheCallbackHtml {
	...
	public LojaVirtualCasasBahiaDetalheCallbackHtml() {
		//this.setDebug();
	}
	...
	protected void inicioTag(Tag t, String classeNome, String idNome) {
		...
		if (t == HTML.Tag.DIV && "navigation".equals(classeNome)) {
			ligaColeta = true;
		}
		if ("pnlFilter".equals(classeNome)) {
			ligaColeta = false;
		}
	}
