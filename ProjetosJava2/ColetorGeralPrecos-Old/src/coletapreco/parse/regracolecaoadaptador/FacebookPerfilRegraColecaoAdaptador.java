...
import coletapreco.parse.callback.FacebookPerfilListaCallbackHtml;
import coletapreco.parse.callback.FacebookPerfilDetalheCallbackHtml;
import coletapreco.parse.dados.FacebookPerfilDadosParse;
...
public abstract class FacebookPerfilRegraColecaoAdaptador  {
	...
	private ICallbackParse getCallbackLista() {
		...
		if (callbackLista==null) {
			System.out.println("FacebookPerfil ID:" + this.getItemRaiz().getIdObj() + " nao possui Callback em " + this.getClass().getSimpleName() + ".criaListaCallbackHtml()");
		}
	...
	private ICallbackParse getCallbackDetalhe() {
		...
		if (callbackDetalhe==null) {
			System.out.println("FacebookPerfil ID:" + this.getItemRaiz().getIdObj() + " nao possui Callback em " + this.getClass().getSimpleName() + ".criaDetalheCallbackHtml()");
		}
	...
	public FacebookPerfil getItemRaiz() {
