...
public class PalavraProdutoMontador   implements MontadorDaoI { 
    ...
    public  DCIObjetoDominio extraiRegistro( ResultadoLista resultadoLista )  throws  DaoException{
		...
		objeto = FabricaVo.criaPalavraProduto();
	...
	public  DCIObjetoDominio extraiRegistro( ResultadoLista resultadoLista  ,  DCIObjetoDominio entrada  ,  int pos )  throws  DaoException{
		PalavraProduto objeto;
		objeto = (PalavraProduto)entrada;
		  
	  	objeto.setIdPalavraProduto(resultadoLista.getInt(pos++));  
	  	objeto.setIdPalavraRa(resultadoLista.getInt(pos++));  
