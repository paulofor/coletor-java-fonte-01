...
public class ContagemProdutoMontador   implements MontadorDaoI { 
    ...
    public  DCIObjetoDominio extraiRegistro( ResultadoLista resultadoLista )  throws  DaoException{
		...
		objeto = FabricaVo.criaContagemProduto();
	...
	public  DCIObjetoDominio extraiRegistro( ResultadoLista resultadoLista  ,  DCIObjetoDominio entrada  ,  int pos )  throws  DaoException{
		ContagemProduto objeto;
		objeto = (ContagemProduto)entrada;
		  
	  	objeto.setIdContagemProduto(resultadoLista.getInt(pos++));  
	  	objeto.setQuantidade(resultadoLista.getInt(pos++));  
	  	objeto.setData(resultadoLista.getString(pos++));  
	  	objeto.setPercentualDiferenca(resultadoLista.getFloat(pos++));  
	  	objeto.setPossibilidadeErro(resultadoLista.getLogicoConvertido(pos++));  
	  	objeto.setIdNaturezaProdutoRa(resultadoLista.getInt(pos++));  
	  	objeto.setIdLojaVirtualRa(resultadoLista.getInt(pos++));
      	return objeto;
	}
