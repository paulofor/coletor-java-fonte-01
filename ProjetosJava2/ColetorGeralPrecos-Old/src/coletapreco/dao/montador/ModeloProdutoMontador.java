...
public class ModeloProdutoMontador   implements MontadorDaoI { 
	...
	public  DCIObjetoDominio extraiRegistro( ResultadoLista resultadoLista  ,  DCIObjetoDominio entrada  ,  int pos )  throws  DaoException{
		ModeloProduto objeto;
		objeto = (ModeloProduto)entrada;
		  
	  	objeto.setIdModeloProduto(resultadoLista.getInt(pos++));  
	  	objeto.setNomeModeloProduto(resultadoLista.getString(pos++));
      	return objeto;
	}
