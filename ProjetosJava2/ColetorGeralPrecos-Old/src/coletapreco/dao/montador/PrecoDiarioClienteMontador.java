...
public class PrecoDiarioClienteMontador   implements MontadorDaoI { 
    ...
    public  DCIObjetoDominio extraiRegistro( ResultadoLista resultadoLista )  throws  DaoException{
		...
		objeto = FabricaVo.criaPrecoDiarioCliente();
	...
	public  DCIObjetoDominio extraiRegistro( ResultadoLista resultadoLista  ,  DCIObjetoDominio entrada  ,  int pos )  throws  DaoException{
		PrecoDiarioCliente objeto;
		objeto = (PrecoDiarioCliente)entrada;
		  
	  	objeto.setIdPrecoDiarioClientte(resultadoLista.getInt(pos++));  
