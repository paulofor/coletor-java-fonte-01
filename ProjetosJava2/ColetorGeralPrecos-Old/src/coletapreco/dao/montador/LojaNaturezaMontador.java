...
public class LojaNaturezaMontador   implements MontadorDaoI { 
    ...
    public  DCIObjetoDominio extraiRegistro( ResultadoLista resultadoLista )  throws  DaoException{
		...
		objeto = FabricaVo.criaLojaNatureza();
	...
	public  DCIObjetoDominio extraiRegistro( ResultadoLista resultadoLista  ,  DCIObjetoDominio entrada  ,  int pos )  throws  DaoException{
		LojaNatureza objeto;
		objeto = (LojaNatureza)entrada;
		  
	  	objeto.setIdLojaNatureza(resultadoLista.getInt(pos++));  
	  	objeto.setUrlInicial(resultadoLista.getString(pos++));  
	  	objeto.setParseCategoria(resultadoLista.getLogicoConvertido(pos++));  
